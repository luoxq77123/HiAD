...
<?php if (isset($policy['ad_show']) && $policy['ad_show']=='播放器'): ?>
<div class="w6Table w7Table mainForm">
    <input type="hidden" name="ad_id" id="ad_id" value="<?php echo $policy['aid']; ?>" />
    <table border="0" cellpadding="0" cellspacing="0">
        <tbody>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#step_prev").click(function(){
            var url = "<?php echo Yii::app()->createURL('ad/setAd');?>";
            frame_load(url);
            return false;
        })
        // 下一步点击事件
        $("#step_next").click(function(){
            submitForm();
            //var url = "<?php echo Yii::app()->createURL('ad/setLocate');?>";
            //frame_load(url);
            return false;
        })
        // 权重
    ...
    function submitForm(){
        ...
        $.post(
            '<?php echo Yii::app()->createUrl("ad/setPolicy")?>',
            ...
            function(data){
                if(data.code < 1){
                    ...
                    var url = "<?php echo Yii::app()->createURL('ad/setMaterial?aid=');?>"+aid;
                    frame_load(url);
                }
            },
            'json'

...
<div class="tpboder pl_35" id="pt">
    <div class="z"><a href="javascript:void(0);">广告位</a> &gt; <a href="javascript:void(0);">Web广告</a> &gt; 
...
<div class="lr_box">
	<!--左-->
    <?php $this->widget('SitePositionMenu'); ?>
    <!--end 左-->
    <!--右-->
    <div class="right font12" id="info_nav_box">
        ...
        <div id="ggw_box">
			...
			if(isset($_GET['a']) &&  $_GET['a'] == 'table')
				$this->widget('SitePositionTable');
			else
				$this->widget('SitePositionList');
			?>
        </div>
        <!--end 内容替换区-->

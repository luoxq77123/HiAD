    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          ...
          <td>
            <?php echo $form->textField($user, 'email', array('class' => 'txt1 txt5','maxlength'=>50)) ;?> 
          </td>
        </tr>
        <tr>
        ...
        <tr valign="top">
          ...
          <td class="jsry">
              ...
              <p><label><input type="radio" name="User[role_id]" id="User_role_id_<?php echo $one['id'];?>"" value="<?php echo $one['id'];?>"><strong><?php echo $one['name'];?></strong></label><?php echo $one['description'];?></p>
              <?php endforeach;?>

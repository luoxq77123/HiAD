...
<div class="tpboder pl_35" id="pt">
    <div class="z"><a href="#">统计</a> &gt; <a href="#">视频广告统计</a></div>
</div>
<!--end 面包屑-->
<!--导航-->
<div class="san_nav">
...
<div id="stat_list">
    <!--内容替换去区-->
    <?php $this->widget('VideoStatListWidget', array()); ?>
    <!--end 内容替换区-->
</div>
...
function statAdDetailByOrder(id, name) {
    ...
    var url = "<?php echo Yii::app()->createURL('statistics/video');?>?timing="+timing+"&time_period="+time_period+"&relation_type=order&relation_id="+id+"&relation_name="+encodeURIComponent(name);
    frame_load(url);
}
...
function loadStatistics(){
    ...
    var url = "<?php echo Yii::app()->createURL('statistics/video');?>?type="+type+"&timing="+timing+"&ad_id="+ad_id+"&time_period="+time_period+"&ad_name="+encodeURIComponent(ad_name);
    frame_load(url);
}

function loadPage(type){
    var url = "<?php echo Yii::app()->createURL('statistics/video');?>?type="+type;
    frame_load(url);
}

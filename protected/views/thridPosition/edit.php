...
$form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => array('thridPosition/edit?id='.$position['id']),
            'clientOptions' => array(
...
<div class="w6Table mainForm" style="padding-bottom:60px">
          ...
          <tr class="<?php if($position['position_size']!="" && !in_array($position['position_size'],$sizes)) echo "hiden"; ?> size_select" id="size_default">
            ...
            <tr class="<?php if($position['position_size']=="" || in_array($position['position_size'],$sizes)) echo "hiden"; ?> size_select" id="size_defined">
                ...
                <td>
                    ...
                    <input type="text" value="<?php echo $position['position_size']==""? "长" : reset(explode("*",$position['position_size'])); ?>" name="size_x" class="txt1 size_input" />&nbsp;*&nbsp;<input type="text" name="size_y" value="<?php echo $position['position_size']==""? "宽" : next(explode("*",$position['position_size'])); ?>" class="txt1 size_input" />&nbsp;(px)
    ...
    <div class="newAds-right fl">
        ...
        <div id="catalog_select_wrapper" class="newAds-right-inner">
            ...
            <textarea id="Position_adcode" class="txt1<?php if($adCode=="") echo ' hide';?>" style="width:400px; height:200px;"><?php echo $adCode;?></textarea>
        </div>
    </div>

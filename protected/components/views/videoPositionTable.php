...
<div class="right font12" id="info_nav_box">
    <div class="taskbar">
        <div class="line line3"> 
            <a href="<?php echo Yii::app()->createUrl('videoPosition/index');?>" style="float:left;margin-left: 20px;" class="load_frame">&lt;&lt;返回广告位列表</a>
                            ...
                            <td style="width:281px">
                                <div class="date"> 
                                    <?php if ($now_year < $this_year): ?>
                                        <a href="<?php echo Yii::app()->createUrl('videoPosition/table', array('ym' => ($this_year - 1) . $this_month) + $_GET); ?>" area="ggw_box" class="load_frame turnL fl"><?php echo ($this_year - 1); ?></a>
                                    <?php endif; ?>
                                    <a href="<?php echo Yii::app()->createUrl('videoPosition/table', array('ym' => ($this_year + 1) . $this_month) + $_GET); ?>" area="ggw_box" class="load_frame turnR fr"><?php echo ($this_year + 1); ?></a>
                                    <?php
                                    $y_m_s = array();
                            ...
                            <tr>
                                <td class=" monthTurn month" colspan="32">
                                    <?php if ($now_year < $this_year || ($now_year == $this_year && $now_month < $this_month)): ?>
                                        <a href="<?php echo Yii::app()->createUrl('videoPosition/table', array('ym' => date('Ym', strtotime('-1 month', $start_timestamp))) + $_GET); ?>" area="ggw_box" class="load_frame turnL fl">上一月</a>
                                    <?php endif; ?>
                                    <a href="<?php echo Yii::app()->createUrl('videoPosition/table', array('ym' => date('Ym', strtotime('+1 month', $start_timestamp))) + $_GET); ?>" area="ggw_box" class="load_frame turnR fr">下一月</a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#year_month_select').change(function(){
            var url = '<?php echo Yii::app()->createUrl('videoPosition/table', $get); ?>&ym=' + $('#year_month_select option:selected').val();

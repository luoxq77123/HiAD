                ...
                <tr>
                    ...
                    <td>
                        <div class="option">
                            ...
                            <a href="<?php echo Yii::app()->createUrl('material/list', array('aid' => $one->id, 'ad_name' => urlencode($one->name)));?>" title="查看广告物料" class="load_frame">广告物料</a> | 
...
<?php endif; ?>
    ...
    $(function(){
        ...
        $("#add_new_ad").click(function(){
            ...
            var url = "<?php echo Yii::app()->createURL('ad/setAd?do=create'); ?>";
            if (positionId>0) {

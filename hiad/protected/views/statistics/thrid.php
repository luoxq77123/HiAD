...
<div class="tpboder pl_35" id="pt">
    <div class="z"><a href="#">统计</a> &gt; <a href="#">联盟广告统计</a></div>
</div>
<!--end 面包屑-->
<!--导航-->
<div class="san_nav">
    <ul class="san_list">
        <li><a href="javascript:void(0);" class="now">广告位统计</a></li>
        <!--li><a href="">客户统计</a></li-->
    </ul>
</div>
<!--end 导航-->
...
<div id="stat_list">
    <!--内容替换去区-->
    <?php $this->widget('ThridStatListWidget', array()); ?>
    <!--end 内容替换区-->
</div>
...
function loadStatistics(){
    ...
    var url = "<?php echo Yii::app()->createURL('statistics/thrid');?>?type="+type+"&timing="+timing+"&ad_id="+ad_id+"&time_period="+time_period+"&ad_name="+encodeURIComponent(ad_name);
    frame_load(url);
}

function loadPage(type){
    var url = "<?php echo Yii::app()->createURL('statistics/thrid');?>?type="+type;
    frame_load(url);
}

...
<div class="tpboder pl_20 adbox">
    <div class="lxr_sx" style="float:left; width:98%;"><a href="<?php echo $this->createUrl('orders/add'); ?>" id="add" title="新建订单" class="iscbut cbut_jia"><span>新建订单</span></a>
        <div class="fr mr_40" style="float:right;">

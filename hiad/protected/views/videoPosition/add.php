...
$form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => array('videoPosition/add'),
            'clientOptions' => array(
...
<div class="w6Table mainForm" style="padding-bottom:60px">
        ...
        <table class="webadd new_web"  border="0" cellpadding="10" cellspacing="10">
          ...
          <tr>
            ...
            <td><div class="system_tips_box_td"><?php if (!empty($adShows)): ?>
              ...
              <input type="radio" name="Position[ad_show_id]" id="<?php echo $one['code'];?>" value="<?php echo $one['id'];?>" <?php if($one['id']==8) echo 'checked="checked"';?> />
    ...
    <div class="newAds-right fl">
        <!-- 直播频道广告选择 -->
        <div id="channel_select_wrapper" class="newAds-right-inner" style="display:none;">
            <div id="selected_channel"></div>
            <a href="javascript:void(0);" id="btn_select_channel" class="item-block">点击绑定直播频道</a>
        </div>
        
        <!-- 视频栏目广告选择 -->
        <div id="catalog_select_wrapper" class="newAds-right-inner" style="display:none;">
            <div id="selected_catalog"></div>
            <a href="javascript:void(0);" id="btn_select_catalog" class="item-block">点击绑定视频栏目</a>
        </div>
        
        <!-- 播放器广告选择 -->
        <div id="player_select_wrapper" class="newAds-right-inner">
...
<div class="popUp" id="select_channel_box" style="display:none">
	<div class="popheader">
        <div class="fl">选择直播频道</div>
    ...
    <div class="popMain popHeight">
        ...
        <div class="fr"><a href="javascript:void(0);" onclick="getSelectedChannel()"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/btn10.gif"/></a><a href="javascript:void(0);" class="popBtn1" onclick="closePopupBox()"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/btn12.gif"/></a></div>
    </div>
</div>

            ...
            <tr>
                        ...
                        <div class="cont">
                            <div id="c_caidan" style="width:430px;">
                                ...
                                <div class="f_l date_select" style="margin-left:2px;margin-right:0px;">
                                    ...
                                    <a href="javascript:;"></a> </div>
                                <input type="text" name="name_searchs" id="video_search" title="请输入视频名称" class="input_s" style="float:left;margin-right: 5px;width:100px;*width:80px; display:inline-block;">
                                <div class="f_l">
                ...
                <td valign="top">
                    <table style="width:240px;margin:auto;">
                        <tr>
                            <td colspan="2"><div id="video_preview_box" style="width:240px;height:200px;"><div id="video_player" style="width:240px;height:198px;border:1px solid #ccc;text-align:center;line-height:198px;">视频预览</div></div></td>
                        </tr>
                        ...
                        <tr>
                            <td width="80" class="vpreview-tit" valign="top">电视剧名称：</td>
                            <td ><div class="cnt_video" id="cnt_video_tit"></div></td>
                        </tr>
                        <tr>
                            <td width="80" class="vpreview-tit">电视剧集数：</td>
                            <td id="cnt_video_duration"></td>
                        </tr>
                        <tr>
                            <td width="80" class="vpreview-tit">电视剧标签：</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".bt_search").click(function() {
            ...
            $("#map_depot_wrapper").load('<?php echo Yii::app()->createUrl("Video/ajaxSerieList"); ?>?' + params);
            return false;
        });
        ...
        $(".bt_search_reset").click(function() {
            ...
            $("#map_depot_wrapper").load("<?php echo Yii::app()->createUrl("Video/ajaxSerieList"); ?>");
            return false;
        });
    });
    ...
    function preview_vedio(id, params) {
        ...
        $("#cnt_video_duration").html("共"+params.duration+"集");

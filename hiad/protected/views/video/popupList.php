            ...
            <tr>
                ...
                <td valign="top">
                    <table style="width:240px;margin:auto;">
                        <tr>
                            <td colspan="2">
                                <div id="video_preview_box" style="width:240px;height:200px;">
                                    <div id="video_player" style="width:240px;height:198px;border:1px solid #ccc;text-align:center;line-height:198px;">视频预览</div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td width="80" class="vpreview-tit" valign="top">视频名称：</td>
                            <td ><div class="cnt_video" id="cnt_video_tit"></div></td>
                        </tr>
                        <tr>
                            <td width="80" class="vpreview-tit">视频时长：</td>
                            <td id="cnt_video_duration"></td>
                        </tr>
                        <tr>
                            <td width="80" class="vpreview-tit">视频标签：</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".bt_search").click(function() {
            ...
            $("#map_depot_wrapper").load('<?php echo Yii::app()->createUrl("Video/ajaxGetList"); ?>?' + params);
            return false;
        });
        ...
        $(".bt_search_reset").click(function() {
            ...
            $("#map_depot_wrapper").load("<?php echo Yii::app()->createUrl("Video/ajaxGetList"); ?>");
            return false;
        });
    });
    ...
    function preview_vedio(id, params) {
        ...
        if(!params.supportTs || !params.supportMp4){
            ...
            $('#clientSupport td').html('该视频不支持'+error_message.join(',')+'客户端播放，请在vms中设置相应转码格式。不支持选中');
            $('#clientSupport').show();
        }else{
            $('#clientSupport').hide();
        }

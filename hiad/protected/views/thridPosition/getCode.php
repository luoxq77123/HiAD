    ...
    <div id="info_nav_box" class="right font12" style="width: 100%; ">
        ...
        <div class="san_nav">
            <ul class="fl san_list" id="san_list">
                <li><a href="<?php echo $this->createUrl('thridPosition/index'); ?>" class="load_frame">广告位</a></li>
        ...
        <div class="w3Table">
            <div class="in">
                <div class="step1 fl" id="position_list_area">
                    <?php $this->widget('ThridCodePositionList'); ?>
                </div>
    ...
    function position_check(){
        ...
        if(choose.length > 0){
            ...
            for(var j=0;j<choose.length;j++){
                ...
                code_val = '<!-- 广告位：'+positionids[positionid]+' -->\r\n<iframe frameborder="0" height="100%" width="100%" style="overflow:hidden;border:none;" src="<?php echo $interfaceUrl;?>thridAd?pid='+positionid+'"></iframe>';
                
                var code_text = '<div class="getcode-panel_texteare"><textarea id="head_code'+positionid+'" class="getcode-panel_text2" readonly="1" style="height: 60px;">'+code_val+'</textarea><a href="javascript:void(0);"  id="b_clip'+positionid+'"  style="color:#50728D;" onmouseover="copyToClipboard(\'head_code'+positionid+'\' ,\'b_clip'+positionid+'\',\'copy_ok'+positionid+'\')">复制代码</a><span id="copy_ok'+positionid+'" style="display:none;" class="getcode_copy_ok">复制成功</span></div>';

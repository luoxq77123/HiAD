...
<table class="webadd new_web"  border="0" cellpadding="10" cellspacing="10">
  ...
  <tr>
    ...
    <td ><div class="system_tips_box_td"><?php if (!empty($adShows)): ?>
      ...
      <input type="radio" name="Position[ad_show_id]" id="<?php echo $one['code'];?>" value="<?php echo $one['id'];?>" <?php if($one['id']==4) echo 'checked="checked"';?> />
  ...
  <tr>
    <th><span class="notion">*</span><?php echo $form->label($appPosition, 'app_id');?></th>
    <td ><div class="system_tips_box_td"><?php echo $form->dropDownList($appPosition, 'app_id', $apps, array('class' => 'txt1')); ?> <a href="<?php echo $this->createUrl('app/add'); ?>" class="suosu" id="add_gs" title="新建应用">新建应用</a></div>
      <!--<div class="system_tips_box">
        <ul>
          <li><a href="javascript:void(0);"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/tit4.gif" />
            <div>
              <dt>什么是应用</dt>
              <dd style="text-indent:0em !important;text-indent: -3.4em;">对自己的广告进行划分，明确其属于什么样的广告。 </dd><dfn></dfn>
            </div>
            </a></li>
        </ul>
      </div>--></td>
  </tr>
  <tr class="size_select ios_attr" id="size_default">
  ...
  <tr class="size_select android_attr hiden" id="size_scale_xs">
    <th><span class="notion">*</span>宽度比例</th>
    <td><input type="text" value="" name="scale_xs" class="txt1 w_40" />
      % <span>(广告位宽度与屏幕宽度比例0-100之间)</span>
      <label for="scale_xs" generated="true" class="error"></label></td>
  </tr>
  <tr class="hiden android_attr size_select" id="size_scale_xy">
    <th><span class="notion">*</span>宽高比例</th>
    <td><input type="text" value="" name="scale_x" class="txt1 w_40" />
      :
      <input type="text" value="" name="scale_y" class="txt1 w_40" />
      <span>(广告位宽度与高度比例)</span>
      <label for="scale_x" generated="true" class="error"></label>
      <label for="scale_y" generated="true" class="error"></label></td>
  </tr>
  <tr valign="top" class="ad_type_more pop_more hiden">
    <th>是否全屏</th>
    <td><?php echo $form->radioButtonList($appPosition, 'is_full', AppPosition::model()->getIsOption(), array('separator' => ' '));?>
      <label for="AppPosition_is_full" generated="true" class="error"></label></td>
  </tr>
  <tr valign="top" class="ad_type_more pop_more pop_ios_attr hiden">
    <th>距左距离</th>
    <td><input type="text" value="" name="left" class="txt1 w_40" />
      <span>(广告位距左距离以像素为单位)</span>
      <label for="left" generated="true" class="error"></label></td>
  </tr>
  <tr valign="top" class="ad_type_more pop_more pop_ios_attr hiden">
    <th>距上距离</th>
    <td><input type="text" value="" name="top" class="txt1 w_40" />
      <span>(广告位距上距离以像素为单位)</span>
      <label for="top" generated="true" class="error"></label></td>
  </tr>
  <tr valign="top" class="ad_type_more pop_android_attr pop_more hiden">
    <th>左偏移值</th>
    <td><input type="text" value="" name="offset_left" class="txt1 w_40" />
      <span>(广告位距左比例（0-100）%)</span>
      <label for="offset_left" generated="true" class="error"></label></td>
  </tr>
  <tr valign="top" class="ad_type_more pop_android_attr pop_more hiden">
    <th>上偏移值</th>
    <td><input type="text" value="" name="offset_top" class="txt1 w_40" />
      <span>(广告位距上比例（0-100）%)</span>
      <label for="offset_top" generated="true" class="error"></label></td>
  </tr>
  <tr valign="top">
    <th><?php echo $form->label($appPosition, 'staytime');?></th>
    <td><span id="st_unlimit" class="st_limit">不限&nbsp;<a href="javascript:void(0);" style="margin:0;" onClick="st_limit('limit');">更改</a></span> <span id="st_limit" class="hiden st_limit"> <?php echo $form->textField($appPosition, 'staytime', array('class' => 'txt1 pssinput')) ;?>秒 <a href="javascript:void(0);" style="margin:0;" onClick="st_limit('unlimit');">不限</a> </span>&nbsp;
      <label for="AppPosition_staytime" generated="true" class="error"></label></td>
  </tr>
  <tr valign="top">
...
<div class="add hicreat">
  ...
  <div id="duo" style="display:none;"><a href="javascript:void(0);" onClick="javascript:xZhankai('duo','shao');"><span>︽</span>高级设置</a>
    <p> <?php echo $form->label($appPosition, 'idle_take');?> <?php echo $form->radioButtonList($appPosition, 'idle_take', AppPosition::model()->getIdleTakeOption(), array('separator' => ' '));?> 

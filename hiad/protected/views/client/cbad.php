...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="tpboder adbox pl_35" width="96%">
         ...
         <?php elseif($type == 2):?>
            <div class="lxr_sx preview_box"><?php if (!empty($data)): ?><img style="cursor:pointer;" src="<?php echo Yii::app()->request->baseUrl.$data['url']; ?>" onerror="this.src='<?php echo Yii::app()->request->baseUrl; ?>/images/none.png';" width="<?php echo $data['pic_x']; ?>" height="<?php echo $data['pic_y']; ?>" /><?php endif; ?></div>
         <?php elseif($type == 3):?>

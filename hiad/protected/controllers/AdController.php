...
class AdController extends BaseController {
    ...
    public function actions() {
        return array(
            'setAd' => 'application.controllers.ad.SetAdAction', //设置广告
            'setPolicy' => 'application.controllers.ad.SetPolicyAction', //设置投放策略
            'setMaterial' => 'application.controllers.ad.SetMaterialAction', //设置素材
        );
    }
